...
async function main() {
  ...
  server.tool("capture",
    "Capture a thought into the cognitive graph. If nodeType is provided, stores as that type directly. If omitted, runs inline extraction to classify the text into properly typed nodes. Automatically creates edges to related existing nodes via semantic similarity. WRITES to SQLite.",
    {
